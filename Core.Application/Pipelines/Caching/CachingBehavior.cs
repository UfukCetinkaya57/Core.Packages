    ...
    where TRequest : IRequest<TResponse>, ICachableRequest
{
    ...
    public CachingBehavior(IDistributedCache cache, CacheSettings cacheSettings/*ILogger<CachingBehavior<TRequest, TResponse>> logger*/, IConfiguration configuration)
    {
